...
class AppTheme extends ChangeNotifier {
  ...
  set color(final AccentColor color) {
    _color = color;
    notifyListeners();
  }
  ...
  set displayMode(final PaneDisplayMode displayMode) {
  ...
  set indicator(final NavigationIndicators indicator) {
  ...
  set textDirection(final TextDirection direction) {
